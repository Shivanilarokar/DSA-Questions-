...
- Included a code snippet demonstrating example function usage.
...
## Usage
To use the solutions provided in this repository, navigate to the respective folder and run the Python files.
