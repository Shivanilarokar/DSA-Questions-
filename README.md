...
## Usage
Once you've cloned the repository, you can explore the questions and solutions provided. Here's a simple example of a Fibonacci function:
...
Feel free to dive into the repository and start practicing DSA questions! Happy coding! 🎉
```