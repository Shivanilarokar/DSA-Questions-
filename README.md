...
## Example
The provided example function `greet()` serves as a simple demonstration of how to structure your code. Modify and extend it as you explore more complex DSA problems.
