...
## Usage
Once cloned, navigate to the repository directory and start exploring the DSA problems. Each problem includes its own instructions and examples.

## Example
Here is a simple example of how to define a problem in the repository:
...
Feel free to contribute by adding your solutions or enhancing existing problems!
```