...
## Example
Here is an example of a function implementation:
...
Feel free to explore and contribute to the repository! Your contributions can help others improve their DSA skills.
```