...
In the latest update, the `README.md` file has been improved to provide clearer instructions and better organization. Notable changes include:
- Enhanced clarity in the installation instructions.
- Added a new section for example functions to aid understanding.
