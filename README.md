...
## Example
Here’s a simple example of how you might define a solution in Python:
...
Feel free to contribute to the repository and improve the collection of DSA questions! 🚀
```