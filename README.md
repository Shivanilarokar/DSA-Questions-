...
In the recent update, we have made several modifications to improve the README file:
- Removed redundant sections for better clarity and conciseness.
- Updated formatting to enhance readability.
- Streamlined the example section while retaining essential information.
