...
- Updated the **Usage** section to provide a clearer guide on how to use the solutions.
- Introduced an **Example** section to demonstrate how to implement a solution function.
...
1. Choose a question from the collection.
2. Implement the solution in your preferred programming language.
3. Test your solution against provided examples.
...
Feel free to explore the collection and contribute your own solutions! Happy coding! 🎉
```