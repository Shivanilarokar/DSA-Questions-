...
## Usage
Once you have the repository cloned, you can navigate through the folders and start practicing the DSA questions.

## Example
Here’s a simple example of how to structure a solution in Python:
