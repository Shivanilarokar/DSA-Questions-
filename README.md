...
## Usage
To use the provided solutions, navigate to the directory of the cloned repository and run the relevant Python scripts.

### Example
Here is a small snippet of code to demonstrate how you can use the functions provided in this repository:
