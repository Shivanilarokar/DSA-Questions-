...
## Usage
Explore various DSA problems and their solutions. Each problem includes a detailed explanation of the approach and a code implementation.
...
# Example usage
print(example_problem([5, 2, 9, 1, 5, 6]))
```
