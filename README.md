...
- Added a command to navigate into the cloned directory after cloning the repository.
...
## Usage
Once you have cloned the repository, you can explore the various DSA questions and their solutions. Here's an example function structure to get you started:
