...
## Installation
To get started with this repository, simply clone it using the command:
...
## Usage
Navigate through the repository to find various DSA problems and their respective solutions. Each problem includes clear instructions and example solutions.

## Example
Here's a simple function to give you an idea of the solution format:
