...
## Usage
Explore the various problems provided in this repository. Each problem includes a description and sample code to help you understand the requirements.

Here's a simple example of a problem structure you might encounter:
