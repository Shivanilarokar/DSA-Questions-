...
## Usage
To utilize the DSA Questions, navigate through the problems listed in the repository, choose a problem, and follow the provided examples and documentation to implement your solution.

### Example:
Here is a simple example of how you can structure your solution:
```python
